...
describe('Graph API Fetch without access token', () => {
    ...
    it('should not throw errors and be set as wished', async () => {
        ...
        expect(fetch.apiConfig.uri).toBe("https://graph.microsoft.com/v1.0/users?$count=true&$select=businessPhones,displayName,givenName,homePhones,jobTitle,department,mail,mobilePhone,officeLocation,preferredLanguage,surname,userPrincipalName,id,identities,userType,externalUserState,accountEnabled,customSecurityAttributes,faxNumber");
