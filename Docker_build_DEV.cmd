...
docker buildx build --no-cache --push -t ahaen/azuread-ldap-wrapper:dev --platform linux/arm64,linux/amd64,linux/s390x,linux/arm/v8,linux/arm/v7,linux/arm/v6 .
pause